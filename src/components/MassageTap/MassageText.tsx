      ...
      {chat &&
        chat.map((e: ChatData, i: number) => {
          ...
          if (e.from !== userNumber && e.type === "text") {
            return (
              <span
                className="block w-fit max-w-[190px] h-fit bg-[#f1f1f1] p-[12px] pl-[15px] pr-[15px] rounded-bl-[30px] rounded-e-3xl overflow-hidden text-box-right"
                key={i}
              >
            ...
            if (e.from === userNumber) {
              return (
                <span
                  className="ml-auto block w-fit h-38 max-w-[190px] max-h-38 overflow-hidden text-image rounded-xl p-0.5 bg-blue-500"
                  key={i}
                >
                  <img
                    src={image}
              ...
              return (
                <span
                  className="block w-fit h-38 max-w-[190px] max-h-38 overflow-hidden text-image rounded-xl p-0.5 bg-[#f1f1f1]"
                  key={i}
                >
                  <img
                    src={image}
            ...
            if (e.from === userNumber) {
              return (
                <>
                  ...
                  <span
                    className="ml-auto block w-fit max-w-[190px] h-fit bg-blue-500 p-[12px] pl-[15px] pr-[15px] rounded-br-[30px] rounded-s-3xl overflow-hidden text-box-left"
                    key={i + 1}
                  >
